...
// ---------------------------------------------------------------- aggregate metrics
export type MetricKey = 'success' | 'pb_valid' | 'clash_free' | 'pocket_hit' | 'contact_retention' | 'relax_de' | 'excess_relax_de' | 'strain_local' | 'excess_strain_local'
...
// ---------------------------------------------------------------- scatter y axes
export type ScatterY = 'rmsd' | 'contact_retention' | 'shape_overlap' | 'relax_de' | 'excess_relax_de' | 'strain_local' | 'excess_strain_local' | 'clashes_pose' | 'pb_fails'
